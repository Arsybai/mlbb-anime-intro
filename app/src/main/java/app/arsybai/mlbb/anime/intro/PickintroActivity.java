...
public class PickintroActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.pickintro);
	...
	protected void onActivityResult(int _requestCode, int _resultCode, Intent _data) {
		...
		switch (_requestCode) {
			...
			if (_resultCode == Activity.RESULT_OK) {
				...
				FileUtil.copyFile(_filePath.get((int)(0)), FileUtil.getExternalStorageDir().concat("/Download/mlbbAnimeIntro/splash.mp4"));
				intent.putExtra("IS_PICKED", "true");
